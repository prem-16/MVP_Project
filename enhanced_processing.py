...
def crop_and_enhance_image(image_path):
    ...
    top_margin = int(height * 0.47)     # 47% from top
    bottom_margin = int(height * 0.13)   # 13% from bottom
    left_margin = int(width * 0.20)      # 20% from left
    right_margin = int(width * 0.48)     # 48% from right
...
if __name__ == "__main__":
    image_path = "images/test_image_FG37.jpg"
